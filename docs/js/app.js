...
/* `lang` on the textarea is what points the keyboard's own dictation key at
   the right language, which is the dictation that actually works here — the
   in-page mic buttons were removed because Safari doesn't implement the Web
   Speech API for recognition, and Deb's phone is the only device this runs
   on. */
